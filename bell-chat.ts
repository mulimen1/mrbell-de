...
export default async function handler(req: Request) {
  ...
  try {
    ...
    const stepInfo =
      body.step === 0
        ? "AKTUELLER STEP: PHASE 1 — Begrüßung + Q&A. Begrüße den User mit dem exakten Begrüßungstext (mit 👋 nach 'Hallo!') und warte auf seine Antwort. Falls er Fragen hat, beantworte sie kurz und freundlich (gerne mit passendem Smiley wie 😊 oder ✨). Falls er starten möchte, gehe zu Frage 1 über."
        : body.step === 1
        ? "AKTUELLER STEP: PHASE 2, Frage 1 — Falls noch nicht passiert: Stelle die erste Frage 'In welcher Branche sind Sie tätig?' und beginne mit einem freundlichen Übergang ('Super!' oder 'Klasse!') und passendem Smiley (z.B. 🎯 oder ✨). Falls User noch in Q&A-Phase ist, beantworte erst seine Frage."
        : body.step === 2
        ? "AKTUELLER STEP: PHASE 2, Frage 2 — Bestätige kurz die Business-Antwort des Users mit Smiley (z.B. 'Spannend! 🛠️' für Klempner oder 'Klasse! ✂️' für Friseur — passe Smiley zur Branche an) und stelle die zweite Frage (Du oder Sie?). WICHTIG: Du/Sie mit ** umschließen für Fett."
        : body.step === 3
        ? "AKTUELLER STEP: PHASE 2, Frage 3 — Bestätige kurz mit Smiley (z.B. 'Perfekt! 👍' oder 'Verstanden! ✨') und stelle die letzte Frage (Was ist Ihnen/dir bei Ihrem/deinem Kundenservice am wichtigsten?). Wechsle Tonfall (Du/Sie) basierend auf Antwort 2."
        : "AKTUELLER STEP: PHASE 3, CTA — Greife zuerst die Antwort des Users auf Frage 3 mit einem persönlichen Satz UND passendem Smiley auf (z.B. '**Schnelligkeit und Effizienz** 🚀 sind eines unserer höchsten Werte!'), dann generiere den CTA mit 'Genug gespielt.' Schließe mit '**Simpel und schnell!** ⚡' und gib am Ende [CTA_READY] aus.";
